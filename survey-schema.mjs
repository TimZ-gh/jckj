...
export const COMMON_QUESTIONS = [
  {
    ...
    label: "你负责的固定工作有哪些？",
    type: "textarea",
    placeholder: "请按条列出，例如：上架商品、写 Listing、剪辑视频、联系达人",
  },
  {
    id: "task_source",
    label: "任务通常由谁或什么触发？",
    type: "checkbox",
    options: ["老板安排", "主管分配", "产品上新", "运营计划", "平台数据", "达人 / 客户反馈", "临时需求"],
  },
  {
    id: "needed_materials",
    label: "开始工作前必须拿到哪些资料？",
    type: "textarea",
    placeholder: "请列出资料名称，例如：产品表、图片、价格、竞品链接、历史数据",
  },
  {
  ...
  },
  {
    ...
    label: "最重复、最适合标准化的工作是什么？",
    type: "textarea",
    placeholder: "请列出 1-5 项，例如：复制资料、整理关键词、改写话术、填写表格",
  },
  {
    id: "output_receiver",
    label: "你的工作完成后交给谁？",
    type: "text",
    placeholder: "请填写岗位或人名，例如：运营主管、剪辑、老板",
  },
  {
    id: "reviewer",
    label: "谁负责审核？",
    type: "text",
    placeholder: "如果无需审核，请填写“无”",
  },
  {
    id: "time_consuming",
    label: "最耗时的 1-3 个步骤是什么？为什么？",
    type: "textarea",
    placeholder: "例如：等产品资料、找竞品、反复改文案、人工统计数据",
  },
  {
    id: "rework_causes",
    label: "最常见的返工原因是什么？",
    type: "textarea",
    placeholder: "例如：资料不全、表达违规、素材不清楚、审核标准不统一",
  },
  {
    id: "current_templates",
    label: "是否已有可复用模板或 SOP？",
    type: "radio",
    options: ["有，且经常使用", "有，但不完整", "没有，主要靠个人经验", "不清楚"],
  },
  {
    id: "records_saved",
    label: "工作结果是否会统一保存并复用？",
    type: "radio",
    options: ["会，且容易查找", "会，但查找不方便", "只保存一部分", "基本不保存"],
  },
  {
    id: "ideal_dashboard",
    label: "如果做系统，你最需要哪个操作页面？",
    type: "textarea",
    placeholder: "例如：待办任务、产品资料、AI 草稿、审核列表、达人跟进、数据复盘",
  },
];
